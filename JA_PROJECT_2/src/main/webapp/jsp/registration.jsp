...
<body>
	...
	<div class="container">
	    ...
	    <form:form method="POST" action="${contextPath}/registration" enctype="multipart/form-data">
			...
			<input type="text" name="firstName" class="form-control" placeholder=" First name" autofocus="true"></input>
			<br>
			<input type="text" name="lastName" class="form-control" placeholder=" Last name" autofocus="true"></input>
			<br>
